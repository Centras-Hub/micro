...
use Centras\Layers\Infrastructure\MessageBroker\RabbitMQ\RabbitMQ;
...
class CentrasServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->singleton('rabbit', function() {
            return (new RabbitMQ())->setConnection()->createExchange('micro');
        });
